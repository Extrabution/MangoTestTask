...
# [GCC 9.4.0]
# Embedded file name: /mnt/c/Users/Xtrabatya/Desktop/InnopolisITP/PythonProjects/MangoTestovoe/src/api/routes.py
# Compiled at: 2023-02-01 03:17:46
...
def register(app):
    ...
    async def signin(username: 'str'=Form(), password: 'str'=Form()):
        ...
        print('!!!!!!')
        return         return {**{'access_token':access_token, 
         'token_type':'bearer'}, **(convert_user_to_dto(user))}
...
# okay decompiling routes.cpython-38.pyc
